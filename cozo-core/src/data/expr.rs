...
pub(crate) fn get_op(name: &str) -> Option<&'static Op> {
    Some(match name {
        ...
        "to_local_parts" => &OP_TO_LOCAL_PARTS,
        "from_local_parts" => &OP_FROM_LOCAL_PARTS,
        "year" => &OP_YEAR,
        "month" => &OP_MONTH,
        "day" => &OP_DAY,
        "dow" => &OP_DOW,
        "hour" => &OP_HOUR,
        "minute" => &OP_MINUTE,
        "days_in_month" => &OP_DAYS_IN_MONTH,
        "start_of_day_local" => &OP_START_OF_DAY_LOCAL,
        "interval" => &OP_INTERVAL,
        "interval_len" => &OP_INTERVAL_LEN,
        "interval_intersects" => &OP_INTERVAL_INTERSECTS,
        "interval_overlap" => &OP_INTERVAL_OVERLAP,
        "interval_union" => &OP_INTERVAL_UNION,
        "interval_minus" => &OP_INTERVAL_MINUS,
        "interval_adjacent" => &OP_INTERVAL_ADJACENT,
        "interval_merge_adjacent" => &OP_INTERVAL_MERGE_ADJACENT,
        "interval_shift" => &OP_INTERVAL_SHIFT,
        "interval_contains" => &OP_INTERVAL_CONTAINS,
        "interval_contains_interval" => &OP_INTERVAL_CONTAINS_INTERVAL,
        "allen_before" => &OP_ALLEN_BEFORE,
        "allen_meets" => &OP_ALLEN_MEETS,
        "allen_overlaps" => &OP_ALLEN_OVERLAPS,
        "allen_starts" => &OP_ALLEN_STARTS,
        "allen_during" => &OP_ALLEN_DURING,
        "allen_finishes" => &OP_ALLEN_FINISHES,
        "allen_equals" => &OP_ALLEN_EQUALS,
        "allen_after" => &OP_ALLEN_AFTER,
        "allen_met_by" => &OP_ALLEN_MET_BY,
        "allen_overlapped_by" => &OP_ALLEN_OVERLAPPED_BY,
        "allen_started_by" => &OP_ALLEN_STARTED_BY,
        "allen_contains" => &OP_ALLEN_CONTAINS,
        "allen_finished_by" => &OP_ALLEN_FINISHED_BY,
        "expand_weekly_days" => &OP_EXPAND_WEEKLY_DAYS,
        "expand_monthly_setpos" => &OP_EXPAND_MONTHLY_SETPOS,
        "normalize_intervals" => &OP_NORMALIZE_INTERVALS,
        "intervals_minus" => &OP_INTERVALS_MINUS,
        "nth_weekday_of_month" => &OP_NTH_WEEKDAY_OF_MONTH,
        "local_minutes_to_parts" => &OP_LOCAL_MINUTES_TO_PARTS,
        "parts_to_instant_utc" => &OP_PARTS_TO_INSTANT_UTC,
        "bucket_of" => &OP_BUCKET_OF,
        "bucket_start" => &OP_BUCKET_START,
